  ...
  return (
    <div>
      <div className="lg:flex max-lg:flex max-lg:flex-col-reverse">
        <div className="lg:w-[50%] flex flex-col lg:gap-8 bg-red-600 text-white lg:p-24 p-12">
      ...
      <div className="lg:flex ">
        <div className="lg:w-[50%] flex flex-col gap-8 lg:p-20 p-2">
          <p className="lg:text-2xl text-xl font-semibold text-red-600">
            Filling machine <br />
            ambient 1000 ML
          </p>
      ...
      <div className="grid lg:grid-cols-3 lg:gap-10 lg:pl-32 p-2 lg:pr-32">
        ...
        <div className="flex flex-col lg:gap-5">
          <p className="text-xl text-red-600 font-bold">Cap applicator</p>
          <p className="lg:text-lg">
