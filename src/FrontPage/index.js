    ...
    return (
        <>
            ...
            <div className='flex justify-center p-5 pt-20'>
                ...
                <div className='w-[40%] mt-3 border-collapse h-[23.2rem] bg-slate-100 flex flex-col gap-5 justify-center'>
            ...
            <div className='flex gap-10 justify-center p-5'>
                ...
                <div className='w-[30%]'>
                    ...
                    <div className=' relative ml-5 mr-5 flex flex-col gap-2 mt-[14rem] bg-slate-200 border-collapse h-[15rem] p-5'>
                ...
                <div className='w-[30%]'>
                    ...
                    <div className=' relative ml-5 mr-5 flex flex-col gap-5 mt-[14rem] bg-slate-200 border-collapse h-[15rem] p-5'>
